    ...
    if command == "init":
        ...
        try:
            ...
            if 'rl_stats' in stats:
                ...
                rl_status = 'Entrenado' if rl_stats.get('has_learned', False) else 'No entrenado'
            ...
            if gt_file.exists():
                try:                    
                    ...
                    print("   • Ground Truth: JSON inválido")
                except OSError:
                    print("   • Ground Truth: Archivo existe pero no se pudo leer")
