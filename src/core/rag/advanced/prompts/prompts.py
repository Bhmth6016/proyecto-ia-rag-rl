...
RAG_PROMPT_TEMPLATE = ChatPromptTemplate.from_template(
    ...
    **Formato de respuesta requerido** (3 productos exactamente):
    1. 🏷️ **Producto**: [Nombre] (⭐ [Rating]/5)
       💵 **Precio**: [Precio]
       📱 **Características**: [Features principales]
       📝 **Descripción**: [Resumen breve]

    2. 🏷️ **Producto**: [Nombre] (⭐ [Rating]/5)
       💵 **Precio**: [Precio]
       📱 **Características**: [Features principales]
       📝 **Descripción**: [Resumen breve]

    3. 🏷️ **Producto**: [Nombre] (⭐ [Rating]/5)
       💵 **Precio**: [Precio]
       📱 **Características**: [Features principales]
       📝 **Descripción**: [Resumen breve]

    Si no hay suficientes productos relevantes, indica claramente "No encontré suficientes productos que coincidan exactamente" y sugiere alternativas.
    """
)
...
Eres un especialista en mejorar consultas de búsqueda para Amazon. Realiza:
